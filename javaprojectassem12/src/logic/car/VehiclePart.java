...
public enum VehiclePart {
	...
	ENGINE_HYBRID			(VehiclePartType.Engine, 			"Hybrid"),
	...
	TOOLSTORAGE_NONE		(VehiclePartType.ToolStorage,		"No Toolstorage"),
	TOOLSTORAGE_STANDARD	(VehiclePartType.ToolStorage,		"Standard Toolstorage"),
	CARGO_NONE				(VehiclePartType.CargoProtection,	"No Cargo Protection"),
	CARGO_STANDARD			(VehiclePartType.CargoProtection,	"Standard Cargo Protection"),
	CERTIFICATION_NONE		(VehiclePartType.Certification,		"No Certification"),
	CERTIFICATION_STANDARD	(VehiclePartType.Certification,		"Standard Certification"),;
